...
# Yahan quotes ke andar apni asli API Key ("AIzaSy...") paste kar do
API_KEY = "AQ.Ab8RN6IR1Kg3c9VX9D_OmcmvdGHaidzgdBmX9h7hBge-wkG0gQ"

# Client ko explicitly bataya ki yahi key use karni hai
